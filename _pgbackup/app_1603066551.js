...
gsap.to('.second-text-panel-description', {
  onStart: () => {
    desc_2.innerHTML ="<br/>Insert the swabbed specimen to our device";},
  ease: 'power1.out',
  scrollTrigger: {
...
gsap.to('.second-text-panel-description', {
  onStart: () => {
    desc_2.innerHTML ="Swab an animal at the point of capture/care <br/> Insert the swabbed specimen to our device <br/> Receive the result back in 30-60 minutes";
  },
  //this width depends on the characters in the title
  //width: '18.5ch',
  ease: 'power1.out',
